...
### Reference
1. [Comparison MMDetection with Detectron2](https://mmdetection.readthedocs.io/en/latest/model_zoo.html#comparison-with-detectron2)
2. [Realtime comparison mmdetection vs detectron2 and see what are their differences](https://www.libhunt.com/compare-mmdetection-vs-detectron2?ref=compare)
